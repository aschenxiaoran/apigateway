...
{
    public class ServiceDisconveryConfigurationProvider: FileConfigurationProvider {
        public ServiceDisconveryConfigurationProvider(FileConfigurationSource source) : base(source)
        {
        }
